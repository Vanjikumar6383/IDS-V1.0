#!/usr/bin/env python3
"""
IDS v1.0 — INTRUSION DETECTION SYSTEM  v3.0
...
def startup_sequence():
    ...
    print(f"\n  {G}{BOLD}[+] ALL SYSTEMS NOMINAL — INTRUSION DETECTION SYSTEM ONLINE{RST}\n")
    time.sleep(0.3)
...
# ─── MAIN ─────────────────────────────────────────────────────────────────────
def main():
    parser = argparse.ArgumentParser(description='IDSV1.0 Intrusion Detection System v3')
